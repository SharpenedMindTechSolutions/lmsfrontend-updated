...
export default function ForgotPassword() {
  ...
  const submit = async e => {
    ...
    setLoading(true);
    try {
      await api.post('/forgot-password/tutor', { email });
      setSent(true);
    } catch {
    ...
    <div className="auth-page">
      ...
      <div className="auth-card anim-fade-up">
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <p style={{ color:'#6b7280', fontSize:14 }}>Enter your tutor email and we'll send a reset link</p>
        </div>
          ...
          {sent ? (
            <div style={{ textAlign:'center' }}>
              ...
              <p style={{ color:'#6b7280', fontSize:14, lineHeight:1.7 }}>
                If a tutor account with <strong>{email}</strong> exists, a password reset link has been sent.<br/>
            ...
            <form onSubmit={submit} noValidate>
              <div className="form-group">
                ...
                <div className="input-icon-wrap">
                  ...
                  <input type="email" placeholder="tutor@email.com" value={email} onChange={e => setEmail(e.target.value)} autoFocus />
                </div>
              </div>
