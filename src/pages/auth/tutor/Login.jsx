    ...
    <div className="auth-page">
      ...
      <div className="auth-card anim-fade-up">
        <div style={{ textAlign:'center', marginBottom:32 }}>
          ...
          <h2 style={{ fontSize:30, color:'#4c1d95', marginBottom:6 }}>Tutor Login</h2>
          <p style={{ color:'#6b7280', fontSize:14 }}>Sign in to manage your courses and students</p>
        </div>
        ...
        <div className="card" style={{ padding:'32px 30px' }}>
          <form onSubmit={submit} noValidate>
            <div className="form-group">
              ...
              <div className="input-icon-wrap">
                ...
                <input type="email" placeholder="tutor@email.com" value={form.email} onChange={set('email')} />
              </div>
            </div>
            <div className="form-group">
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:6 }}>
                <label style={{ margin:0 }}>Password</label>
                <Link to="/tutor/forgot-password" style={{ fontSize:13, color:'#7c3aed', fontWeight:600, textDecoration:'none' }}>
                  Forgot Password?
                </Link>
              </div>
              <div className="input-icon-wrap">
          ...
          <p style={{ textAlign:'center', marginTop:20, color:'#6b7280', fontSize:14 }}>
            New tutor?{' '}
            <Link to="/tutor/register" style={{ color:'#7c3aed', fontWeight:700, textDecoration:'none' }}>Create account</Link>
          </p>
        </div>
      </div>
    </div>
